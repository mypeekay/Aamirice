...
public class AmStudio2 extends Fragment {
    ...
    private void initView() {
        ...
        smartRefreshLayout = view.findViewById(R.id.smart2);
    ...
    public void getUri() {
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    res = OkHttpUtils.get().url("https://ampk119-1255693066.cos.ap-chongqing.myqcloud.com/AamiricePhone/%E5%9B%BE%E9%9B%86/amstudio3.json")
