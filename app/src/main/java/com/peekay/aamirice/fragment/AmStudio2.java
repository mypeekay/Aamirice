...
public class AmStudio2 extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.amstudio2, null);
        }
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycle_amstudio2);
        swipeRefreshLayout = view.findViewById(R.id.swipe_amstudio2);
                ...
                if (bitmaps.isEmpty()) {
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            request = new Request.Builder().url("https://ampk119-1255693066.cos.ap-chongqing.myqcloud.com/AamiricePhone/%E5%9B%BE%E9%9B%86/amstudio3.txt").build();
                            try {
