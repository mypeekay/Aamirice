...
public class AmStudio4 extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (view == null) {
            view = inflater.inflate(R.layout.amstudio4, null);
        }
        return view;
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.recycle_amstudio4);
        swipeRefreshLayout = view.findViewById(R.id.swipe_amstudio4);
                ...
                if (bitmaps.isEmpty()) {
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            request = new Request.Builder().url("https://ampk119-1255693066.cos.ap-chongqing.myqcloud.com/AamiricePhone/%E5%9B%BE%E9%9B%86/amstudio5.txt").build();
                            try {
