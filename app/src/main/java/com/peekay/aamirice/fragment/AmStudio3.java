...
public class AmStudio3 extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        swipeRefreshLayout = view.findViewById(R.id.swipe_amstudio3);
                ...
                if (bitmaps.isEmpty()) {
                    new Thread(new Runnable() {
                        ...
                        public void run() {
                            ...
                            request = new Request.Builder().url("https://ampk119-1255693066.cos.ap-chongqing.myqcloud.com/AamiricePhone/%E5%9B%BE%E9%9B%86/amstudio4.txt").build();
                            try {
